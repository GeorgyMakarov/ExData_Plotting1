...
with(subset_data, plot(x = date_time, y = Voltage, type = "l",
                       xlab = "datetime", ylab = "Voltage"))

with(subset_data, plot(x = date_time, y = Sub_metering_1, type = "l",
                       xlab = "", ylab = "Energy sub metering"))
with(subset_data, lines(x = date_time, y = Sub_metering_2, col = "red"))
with(subset_data, lines(x = date_time, y = Sub_metering_3, col = "blue"))
legend("topright",
       lty = 1,
       bty = "n",
...
with(subset_data, plot(x = date_time, y = Global_reactive_power, type = "l",
